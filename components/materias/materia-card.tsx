...
function calcularGrading(actividades: Actividad[]) {
        ...
        <CardContent className="flex flex-col gap-4">
          ...
          {materia.horarios.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {materia.horarios.map((h, i) => (
                <div
                  key={i}
                  className="flex items-center gap-1.5 text-xs text-muted-foreground bg-muted/50 px-2 py-1 rounded-md"
                >
          ...
          <div className="grid grid-cols-3 gap-3 text-center bg-muted/30 rounded-lg p-3">
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-xl font-bold" style={{ color: materia.color_hex }}>
                {acumulado70.toFixed(1)}
              </span>
            </div>
            <div className="flex flex-col gap-0.5">
